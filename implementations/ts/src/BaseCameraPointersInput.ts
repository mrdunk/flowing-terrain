 ...
 * for example usage.
 */
export abstract class BaseCameraPointersInput implements BABYLON.ICameraInput<BABYLON.Camera> {
    /**
     * Defines the camera the input is attached to.
     */
    public abstract camera: BABYLON.Camera;
    ...
    public attachControl(noPreventDefault?: boolean): void {
        ...
        var previousMultiTouchPanPosition: BABYLON.Nullable<BABYLON.PointerTouch> = null;
        ...
        this._pointerInput = (p, s) => {
            ...
            if (engine.isPointerLock) {
                ...
                this.pointA = null;
                this.pointB = null;
            } else if (p.type === BABYLON.PointerEventTypes.POINTERDOWN && srcElement) {
                try {
        ...
        if (hostWindow) {
            BABYLON.Tools.RegisterTopRootEvents(hostWindow, [
    ...
    public detachControl(ignored?: any): void {
        if (this._onLostFocus) {
            let hostWindow = this.camera.getScene().getEngine().getHostWindow();
            if (hostWindow) {
                BABYLON.Tools.UnregisterTopRootEvents(hostWindow, [
                    { name: "blur", handler: this._onLostFocus }
                ]);
            }
        }
    ...
    private _onLostFocus: BABYLON.Nullable<(e: FocusEvent) => any>;
    private pointA: BABYLON.Nullable<BABYLON.PointerTouch>;
    private pointB: BABYLON.Nullable<BABYLON.PointerTouch>;
}
